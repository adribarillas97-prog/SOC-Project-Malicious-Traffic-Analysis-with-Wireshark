...
Based on endpoint analysis, external IPs with significant traffic were identified, including 5.252.153.241 (3,475 packets, 235 kB) — flagged as likely C2 based on volume and outbound communication pattern.
